...
class In_Iris_21_0_3(models.Model):
    ...
    res_org_name = models.CharField(max_length=100, null=True, blank=True)  # 주관연구개발기관
    res_manager = models.CharField(max_length=50, null=True, blank=True)  # 연구책임자
    requester = models.CharField(max_length=50, null=True, blank=True)  # 신청자
    res_date = models.CharField(max_length=100, null=True, blank=True)  # 연구개발기간
    req_date = models.CharField(max_length=50, null=True, blank=True)  # 신청일
    req_org_name = models.CharField(max_length=100, null=True, blank=True)  # 신청연구개발기관
    req_org_type = models.CharField(max_length=100, null=True, blank=True)  # 신청연구개발기관 유형
    change_before = models.CharField(max_length=400, null=True, blank=True)  # 변경내용 변경전
    change_after = models.CharField(max_length=400, null=True, blank=True)  # 변경내용 변경후
    change_reason = models.CharField(max_length=400, null=True, blank=True)  # 변경사유
...
class In_Iris_21_1_3(models.Model):
    ...
    group = models.CharField(max_length=50)
    res_num = models.CharField(max_length=100, null=True, blank=True) # 연구개발과제번호
    first_title = models.CharField(max_length=50, null=True, blank=True)
    second_title = models.CharField(max_length=50, null=True, blank=True)
    first_data = models.CharField(max_length=50, null=True, blank=True) # 연구개발단계
    second_data = models.CharField(max_length=50, null=True, blank=True) # 연구개발과제성격
    assign_status = models.CharField(max_length=50) # 과제 상태
    class Meta:
...
class In_Iris_21_1_4(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    security_task_release_date = models.CharField(max_length=50, null=True, blank=True)  # 연구개발과제성격
    class Meta:
...
class In_Iris_21_1_5(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    korean = models.CharField(max_length=50, null=True, blank=True)  # 국문
    english = models.CharField(max_length=50, null=True, blank=True)  # 영문
    content_1 = models.CharField(max_length=50, null=True, blank=True)  # 쓸거
    content_2 = models.CharField(max_length=50, null=True, blank=True)  # 쓸거2
    content_3 = models.CharField(max_length=50, null=True, blank=True)  # 쓸거3
    content_4 = models.CharField(max_length=50, null=True, blank=True)  # 쓸거4
    content_5 = models.CharField(max_length=50, null=True, blank=True)  # 쓸거5
    english_content_1 = models.CharField(max_length=50, null=True, blank=True)  # 영어
    english_content_2 = models.CharField(max_length=50, null=True, blank=True)  # 영어2
    english_content_3 = models.CharField(max_length=50, null=True, blank=True)  # 영어3
    english_content_4 = models.CharField(max_length=50, null=True, blank=True)  # 영어4
    english_content_5 = models.CharField(max_length=50, null=True, blank=True)  # 영어5
...
class In_Iris_21_2_1(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    change_reason = models.CharField(max_length=50, null=True, blank=True) # 변경사유 선택
    step_selection = models.CharField(max_length=50, null=True, blank=True) # 단계선택
    total_research_development_period = models.CharField(max_length=50, null=True, blank=True) # 전체 연구개발기간
    step = models.CharField(max_length=50, null=True, blank=True) # 단계
    annual = models.CharField(max_length=50, null=True, blank=True) # 연차
    research_development_start_date = models.CharField(max_length=50, null=True, blank=True) # 연구개발시작일
    research_development_end_date = models.CharField(max_length=50, null=True, blank=True) # 연구개발종료일
    months = models.CharField(max_length=50, null=True, blank=True) # 개월수
    previous_step = models.CharField(max_length=50, null=True, blank=True) # 기존단계
    previous_annual = models.CharField(max_length=50, null=True, blank=True) # 기존연차
    class Meta:
...
class In_Iris_21_2_2(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    final_goal_content = models.TextField(null=True, blank=True)  # 최종목표내용
    research_development_content = models.TextField(max_length=1333, null=True, blank=True)  # 연구개발내용
    research_development_performance = models.TextField(max_length=1333, null=True, blank=True)  # 연구개발성과
    utilization_plan_and_expected_effect = models.TextField(max_length=1333, null=True, blank=True)  # 활용계획및기대효과
    class Meta:
...
class In_Iris_21_3_1(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    change_item = models.CharField(max_length=50, null=True, blank=True)  # 변경항목
    change_reason = models.CharField(max_length=50, null=True, blank=True)  # 변경사유
    main_research_development_institution = models.CharField(max_length=100, null=True, blank=True)  # 주관연구개발기관
    joint_research_development_institution = models.CharField(max_length=100, null=True, blank=True)  # 공동연구개발기관
    entrusted_research_development_institution = models.CharField(max_length=100, null=True, blank=True)  # 위탁연구개발기관
    ...
    research_development_payment_type = models.CharField(max_length=50, null=True, blank=True)  # 연구개발지급유형
    ...
    participation_annual = models.CharField(max_length=50, null=True, blank=True)  # 참여연차
    government_support = models.CharField(max_length=50, null=True, blank=True)  # 정부지원
...
class In_Iris_21_3_2(models.Model):
    ...
    research_development_institution_name = models.CharField(max_length=100, null=True, blank=True)  # 연구개발기관명
    participation_status = models.CharField(max_length=50, null=True, blank=True)  # 참여여부
    annual_information = models.CharField(max_length=50, null=True, blank=True)  # 연차정보
    start_date = models.CharField(max_length=50, null=True, blank=True)  # 시작일
    end_date = models.CharField(max_length=50, null=True, blank=True)  # 종료일
    student_integration = models.CharField(max_length=50, null=True, blank=True)  # 학생 통합
    equipment_integration = models.CharField(max_length=50, null=True, blank=True)  # 장비 통합
    exception_reason_for_regulation_application = models.CharField(max_length=100, null=True, blank=True)  # 규정 적용 예외 사유
    class Meta:
...
class In_Iris_21_3_3(models.Model):
    ...
    change_item = models.CharField(max_length=50, null=True, blank=True)  # 변경항목
    change_reason = models.CharField(max_length=50, null=True, blank=True)  # 변경사유
    agreement_institution = models.CharField(max_length=100, null=True, blank=True)  # 협약기관
...
class In_Iris_21_3_4(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    role = models.CharField(max_length=50, null=True, blank=True)  # 인력역할
    ...
    researcher_number = models.CharField(max_length=50, null=True, blank=True)  # 국가연구자번호
    new_recruit_type = models.CharField(max_length=50, null=True, blank=True)  # 신규채용구분
    recruitment_date = models.CharField(max_length=50, null=True, blank=True)  # 채용일자
    participation_phase = models.CharField(max_length=50, null=True, blank=True)  # 참여여차
    position_status = models.CharField(max_length=50, null=True, blank=True)  # 직제존속
    supporting_documents = models.CharField(max_length=50, null=True, blank=True)  # 증빙서류
    ethics_guide_provided = models.CharField(max_length=50, null=True, blank=True)  # 연구윤리안내여부
    ethics_agreement_date = models.CharField(max_length=50, null=True, blank=True)  # 연구윤리동의일자
    performance_type = models.CharField(max_length=50, null=True, blank=True)  # 수행구분
...
class In_Iris_21_3_5(models.Model):
    ...
    participation_year = models.CharField(max_length=50, null=True, blank=True)  # 참여연차
    participation_status = models.CharField(max_length=50, null=True, blank=True)  # 참여여부
    highest_degree = models.CharField(max_length=50, null=True, blank=True)  # 최종학위
    major_field = models.CharField(max_length=50, null=True, blank=True)  # 전공계열
    major = models.CharField(max_length=50, null=True, blank=True)  # 전공
    graduation_year = models.CharField(max_length=50, null=True, blank=True)  # 취득연도
    role = models.CharField(max_length=50, null=True, blank=True)  # 담당역할
    participation_type = models.CharField(max_length=50, null=True, blank=True)  # 참여구분
    ...
    participation_start_date = models.CharField(max_length=50, null=True, blank=True)  # 참여시작일자
    participation_end_date = models.CharField(max_length=50, null=True, blank=True)  # 참여종료일자
    ...
    calculated_annual_salary = models.CharField(max_length=50, null=True, blank=True)  # 산출근거 연봉금액
...
class In_Iris_21_3_6(models.Model):
    ...
    position = models.CharField(max_length=50, null=True, blank=True)  # 직위
    support_year = models.CharField(max_length=50, null=True, blank=True)  # 지원연차
    participation_type = models.CharField(max_length=50, null=True, blank=True)  # 참여구분
...
class In_Iris_21_5_1(models.Model):
    ...
    government_support_funds_in_kind = models.CharField(max_length=50, null=True, blank=True)  # 정부지원금 현물
    government_support_funds_ratio = models.CharField(max_length=50, null=True, blank=True)  # 정부지원금 비율
    research_institution_contribution_in_kind = models.CharField(max_length=50, null=True, blank=True)  # 연구개발기관 부담금 현물
    research_institution_contribution_ratio = models.CharField(max_length=50, null=True, blank=True)  # 연구개발기관 부담금 비율
    total_in_kind = models.CharField(max_length=50, null=True, blank=True)  # 합계 현물
    total_ratio = models.CharField(max_length=50, null=True, blank=True)  # 합계 비율
    research_fund_usage_plan = models.CharField(max_length=100, null=True, blank=True)  # 연구개발비 사용계획
    approval_status = models.CharField(max_length=50, null=True, blank=True)  # 승인여부
...
class In_Iris_21_5_2(models.Model):
    ...
    institution_role = models.CharField(max_length=50, null=True, blank=True)  # 기관역할
    research_institution_name = models.CharField(max_length=100, null=True, blank=True)  # 연구개발기관명
    total_research_funds_by_source = models.CharField(max_length=50, null=True, blank=True)  # 재원별 연구비 합계(A)
    research_funds_by_item = models.CharField(max_length=50, null=True, blank=True)  # 비목별 연구비(B)
    unpaid_salary_baseline_amount = models.CharField(max_length=50, null=True, blank=True)  # 미지급인건비 계상기준금액
    difference = models.CharField(max_length=50, null=True, blank=True)  # 차액(A-B)
...
class In_Iris_21_5_3(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    research_funds_by_item = models.CharField(max_length=50, null=True, blank=True)  # 비목별 연구비
...
class In_Iris_21_8_1(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    product_name = models.CharField(max_length=50, null=True, blank=True)  # 제품명
    registration_date = models.CharField(max_length=50, null=True, blank=True)  # 등록일자
    validity_period = models.CharField(max_length=50, null=True, blank=True)  # 유효기간
    certification_body = models.CharField(max_length=100, null=True, blank=True)  # 인증기관
    certification_number = models.CharField(max_length=50, null=True, blank=True)  # 인증번호
...
class In_Iris_21_9_1(models.Model):
    account = models.CharField(max_length=50)
    group = models.CharField(max_length=50)
    document_type = models.CharField(max_length=50, null=True, blank=True)  # 문서유형
    required_status = models.CharField(max_length=50, null=True, blank=True)  # 필수여부
